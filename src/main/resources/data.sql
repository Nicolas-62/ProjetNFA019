...
values('lourdel','nicolas','generaliste','0320998877','nicolas_lourdel@gmail.com','8 rue des oies','Arras','62000',1);
...
insert into patient(num_secu,nom,prenom,tel,mail,adresse,ville,cp,sexe,user_id)
values('1860159350299','Dupond','Roger','0320435678','dupond@gmail.com','12 allee des chênes','Boulogne','62220','h',4);
insert into user(id,identifiant,password,droits) values(5,'FredericLechamp','fred345!',3);
insert into patient(num_secu,nom,prenom,tel,mail,adresse,ville,cp,sexe,user_id)
values('3340159350299','Lechamp','Frederic','0360435678','fredlechamp@gmail.com','3 rue des blés','Marseille','13000','h',5);
insert into user(id,identifiant,password,droits) values(6,'SylvieLemoine','syl504!',3);
insert into patient(num_secu,nom,prenom,tel,mail,adresse,ville,cp,sexe,user_id)
values('1860153957299','Lemoine','Sylvie','09880435678','syllem@gmail.com','34 rue de la bourse','Nantes','33000','f',6);
insert into user(id,identifiant,password,droits) values(7,'PaulineLoiseau','paulloi333!',3);
insert into patient(num_secu,nom,prenom,tel,mail,adresse,ville,cp,sexe,user_id)
values('1860153957344','Loiseau','Pauline','02600435678','loiseau@gmail.com','90 rue de la poste','Bordeaux','22000','f',7);
